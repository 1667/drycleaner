...
if ($_SERVER['REQUEST_METHOD'] == 'POST')  
{
	...
	if($errorMsg == '')
	{
		$config[DAOIMPL]->addDryTip(array("Title"=>$title, "AddTime"=>$add_time, "Content"=>$content, "Count"=>0, "PicFileName"=>$picFileName));
	}
}
////////////////////
?>
...
<div class="mwin" id="page">
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php">首页</a> -> <a href="drytips.php">洗衣小贴士管理</a> -> 添加洗衣小贴士
	<br><br>
