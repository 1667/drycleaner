...
{
	window.location = "<?php echo $config[ADMINBASEURL] . "preferentialactions_edit.php?id=" . $_REQUEST["id"] . "&typeid="; ?>" + service_type;
}
</SCRIPT>

<div class="mwin" id="page">
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php">首页</a> -> <a href="preferentialactions.php">优惠活动</a> -> 编辑优惠活动
	<br><br>
