...
{ 
  ...
  httpPost( "/LANZGateway/Login.asp","UserID=857675&Account=wnxy666&Password=FC3B0F189DD1D252C0BD8B41073247FD0BAF8A3B","",0); 


  httpPost( "/LANZGateway/SendSMS.asp","SMSType=1&Phone=13482833776&Content=PHP 接口测试demo调试&ActiveID=".$_SESSION["activeid"],$_SESSION["session_id"],1); 
